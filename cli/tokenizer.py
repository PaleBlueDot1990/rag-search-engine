...
class Tokenizer:
    def __init__(self):
        """Initialize the tokenizer with a punctuation table, stemmer, and stopword list."""
    ...
    def tokenize_sentence(self, text : str) -> list[str]:
        """Tokenize a sentence by lowercasing, removing punctuation, filtering stopwords, and stemming."""
        text = text.lower()
